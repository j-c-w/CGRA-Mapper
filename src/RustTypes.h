...
RustDFGList optimize_with_egraphs(RustDFG input, Rulesets rules, const char *cgra_params_file, bool print_used_rules, const char *egraph_strategy, bool dump_egraphs);
