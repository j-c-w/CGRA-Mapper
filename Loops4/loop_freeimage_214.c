...
int
fn (INT32 tmp2, INT32 z3, INT32 z1, INT32 tmp11, INT32 tmp0, INT32 tmp12,
    INT32 tmp3, INT32 z2, INT32 tmp1, DCTELEM * dataptr, int ctr, INT32 tmp10)
{
  for (ctr = 0; ctr < 7; ctr++)
    {
	...
	((tmp1 -
      ...
      dataptr[8 * 2] =
	(DCTELEM) (((z1 + z2 + z3) + (((INT32) 1) << ((13 + 2) - 1))) >> (13 +
									  2));
      z1 -= z2;
      z2 =
	((tmp0 -
	...
	(DCTELEM) (((z2 + z3 -
		    ...
		    (((INT32) 1) << ((13 + 2) - 1))) >> (13 + 2));
      dataptr[8 * 6] =
	(DCTELEM) (((z1 + z2) + (((INT32) 1) << ((13 + 2) - 1))) >> (13 + 2));
      tmp1 =
	((tmp10 +
