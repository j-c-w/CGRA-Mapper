...
int
fn (INT32 tmp2, INT32 tmp11, INT32 z1, INT32 tmp3, INT32 tmp0, INT32 tmp12,
  ...
  for (ctr = 8 - 1; ctr >= 0; ctr--)
    {
      ...
      tmp3 = dataptr[8 * 3] - dataptr[8 * 4];
      dataptr[8 * 0] =
	(DCTELEM) (((tmp10 + tmp11) + (((INT32) 1) << ((2 + 1) - 1))) >> (2 +
									  1));
      dataptr[8 * 4] =
	(DCTELEM) (((tmp10 - tmp11) + (((INT32) 1) << ((2 + 1) - 1))) >> (2 +
									  1));
      ...
      dataptr[8 * 2] =
	(DCTELEM) (((z1 + ((tmp12) * (((INT32) 6270)))) +
		    (((INT32) 1) << ((13 + 2 + 1) - 1))) >> (13 + 2 + 1));
      dataptr[8 * 6] =
	(DCTELEM) (((z1 - ((tmp13) * (((INT32) 15137)))) +
		    (((INT32) 1) << ((13 + 2 + 1) - 1))) >> (13 + 2 + 1));
      tmp12 = tmp0 + tmp2;
      tmp13 = tmp1 + tmp3;
	...
	(DCTELEM) (((tmp2) + (((INT32) 1) << ((13 + 2 + 1) - 1))) >> (13 + 2 +
								      1));
      dataptr[8 * 7] =
	(DCTELEM) (((tmp3) + (((INT32) 1) << ((13 + 2 + 1) - 1))) >> (13 + 2 +
								      1));
      dataptr++;
    }
}
