...
int
fn (INT32 tmp2, DCTELEM * wsptr, INT32 tmp14, INT32 tmp5, INT32 tmp4,
    INT32 tmp11, INT32 tmp15, INT32 tmp0, INT32 tmp3, INT32 tmp12,
    INT32 tmp13, INT32 tmp1, DCTELEM * dataptr, int ctr, INT32 tmp10)
{
  for (ctr = 8 - 1; ctr >= 0; ctr--)
	...
	((tmp2 +
      ...
      dataptr[8 * 1] =
	(DCTELEM) (((tmp10) + (((INT32) 1) << ((13 + 1) - 1))) >> (13 + 1));
      dataptr[8 * 3] =
	(DCTELEM) (((tmp11) + (((INT32) 1) << ((13 + 1) - 1))) >> (13 + 1));
      dataptr[8 * 5] =
	(DCTELEM) (((tmp12) + (((INT32) 1) << ((13 + 1) - 1))) >> (13 + 1));
      dataptr[8 * 7] =
	(DCTELEM) (((tmp13) + (((INT32) 1) << ((13 + 1) - 1))) >> (13 + 1));
      dataptr++;
      wsptr++;
    }
}
