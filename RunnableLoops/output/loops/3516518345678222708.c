...
int
fn (const int xcenter, const int fill_color, const int h,
    const int32_t * correction, int i, uint8_t * out, const int off_y,
    const uint8_t * indata, const int ycenter, const int w,
    const int inlinesize)
{
  for (int j = 0; j < w; j++)
    {
