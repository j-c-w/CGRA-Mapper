  ...
  for (i = 0; i < w; i++)
	...
	((dst[0 * dstStride]) +
	 cm[((0 * tmpB + -1 * tmpA + 5 * tmp0 + 5 * tmp1 + -1 * tmp2 +
	      0 * tmp3 + 64 * src2[0 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[1 * dstStride] =
	((dst[1 * dstStride]) +
	 cm[((0 * tmpA + -1 * tmp0 + 5 * tmp1 + 5 * tmp2 + -1 * tmp3 +
	      0 * tmp4 + 64 * src2[1 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[2 * dstStride] =
	((dst[2 * dstStride]) +
	 cm[((0 * tmp0 + -1 * tmp1 + 5 * tmp2 + 5 * tmp3 + -1 * tmp4 +
	      0 * tmp5 + 64 * src2[2 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[3 * dstStride] =
	((dst[3 * dstStride]) +
	 cm[((0 * tmp1 + -1 * tmp2 + 5 * tmp3 + 5 * tmp4 + -1 * tmp5 +
	      0 * tmp6 + 64 * src2[3 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[4 * dstStride] =
	((dst[4 * dstStride]) +
	 cm[((0 * tmp2 + -1 * tmp3 + 5 * tmp4 + 5 * tmp5 + -1 * tmp6 +
	      0 * tmp7 + 64 * src2[4 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[5 * dstStride] =
	((dst[5 * dstStride]) +
	 cm[((0 * tmp3 + -1 * tmp4 + 5 * tmp5 + 5 * tmp6 + -1 * tmp7 +
	      0 * tmp8 + 64 * src2[5 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[6 * dstStride] =
	((dst[6 * dstStride]) +
	 cm[((0 * tmp4 + -1 * tmp5 + 5 * tmp6 + 5 * tmp7 + -1 * tmp8 +
	      0 * tmp9 + 64 * src2[6 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst[7 * dstStride] =
	((dst[7 * dstStride]) +
	 cm[((0 * tmp5 + -1 * tmp6 + 5 * tmp7 + 5 * tmp8 + -1 * tmp9 +
	      0 * tmp10 + 64 * src2[7 * srcStride]) + 32) >> 6] + 1) >> 1;
      dst++;
      tmp++;
      src2++;
}}
