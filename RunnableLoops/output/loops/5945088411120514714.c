...
int
fn (const uint8_t * cm, int cr, uint8_t b, const uint8_t * ycbcr, int y,
    int i, int cb, int num_values, int r_add, int b_add, int g_add, uint8_t g,
    uint32_t * rgba, const uint8_t * alpha, uint8_t r)
{
