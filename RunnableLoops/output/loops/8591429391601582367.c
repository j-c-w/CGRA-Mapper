...
int
fn (int o1, int o2, TXComplex * z, TXSample t3, const TXSample * wim, int len,
    TXSample t1, const TXSample * cos, TXSample t4, TXSample i0, TXSample t5,
    TXSample r0, TXSample i1, TXSample t2, TXSample r1, TXSample t6, int o3)
{
