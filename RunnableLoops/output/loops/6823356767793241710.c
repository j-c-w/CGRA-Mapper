...
int
fn (int tmp6, int tmp0, int tmp11, int z1, int tmp12, int tmp13, int tmp4,
    int tmp1, int tmp3, int tmp2, int tmp5, int tmp10, int ctr, int tmp7,
    int16_t * dataptr)
{
  for (ctr = 8 - 1; ctr >= 0; ctr--)
	...
	(((z1 + ((tmp12) * (-((int32_t) 15137)))) +
      ...
      tmp12 = tmp5 - tmp6;
      tmp13 = tmp4 - tmp7;
      dataptr[8 * 1] = (((tmp10 + tmp11) + (1 << ((4) - 1))) >> (4));
      dataptr[8 * 5] = (((tmp10 - tmp11) + (1 << ((4) - 1))) >> (4));
      z1 = ((tmp12 + tmp13) * (((int32_t) 4433)));
      dataptr[8 * 3] =
	(((z1 + ((tmp13) * (((int32_t) 6270)))) +
	  (1 << ((13 + 4) - 1))) >> (13 + 4));
