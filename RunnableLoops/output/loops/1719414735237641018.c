...
int
fn (int o1, const TXSample * wim, int o2, TXSample t3, int len, TXSample t1,
    TXComplex * z, TXSample t4, const TXSample * cos, TXSample i0,
    TXSample t5, TXSample r0, TXSample i1, TXSample t2, TXSample r1,
    TXSample t6, int o3)
{
