...
int
fn (int o1, const TXSample * wim, TXComplex * z, TXSample r1, int len,
    TXSample t1, TXSample t3, const TXSample * cos, TXSample t4, int o2,
    TXSample i0, TXSample r0, TXSample i1, TXSample t2, TXSample t5,
    TXSample t6, int o3)
{
