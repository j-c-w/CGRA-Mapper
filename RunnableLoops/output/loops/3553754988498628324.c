...
int
fn (FLOAT tmp11, FLOAT tmp1, FLOAT tmp5, FLOAT tmp3, FLOAT tmp6, FLOAT * temp,
    FLOAT z13, FLOAT tmp0, FLOAT tmp10, FLOAT tmp7, FLOAT z11, int i,
    FLOAT tmp13, FLOAT z2, FLOAT tmp4, FLOAT z4, FLOAT tmp12, FLOAT tmp2,
    int16_t * data)
{
  for (i = 0; i < 8 * 8; i += 8)
    {
