...
int
fn (int z2, int tmp6, int z11, int tmp5, int z3, int z5, int tmp4, int tmp2,
    int tmp10, int tmp7, int tmp12, int z13, int tmp1, int tmp3,
    int16_t * dataptr, int tmp0, int z4, int z1, int tmp13, int ctr,
    int tmp11)
{
