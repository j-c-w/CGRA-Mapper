...
int
fn (int o1, const TXSample * wim, TXComplex * z, int o2, int len, TXSample t1,
    TXSample t3, TXSample t4, const TXSample * cos, TXSample r1, TXSample i0,
    TXSample r0, TXSample i1, TXSample t2, TXSample t5, TXSample t6, int o3)
{
