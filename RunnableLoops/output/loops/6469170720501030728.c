...
int
fn (int z2, int z3, int tmp5, int z5, int tmp4, int tmp2, int tmp10, int tmp7,
    ...
    int z4, int z1, int tmp13, int ctr, int tmp6)
{
  for (ctr = 8 - 1; ctr >= 0; ctr--)
	...
	(int16_t) (((z1 + ((tmp12) * (-((int32_t) 15137)))) +
      ...
      z4 += z5;
      dataptr[7] =
	(int16_t) (((tmp4 + z1 + z3) + (1 << ((13 - 4) - 1))) >> (13 - 4));
      dataptr[5] =
	(int16_t) (((tmp5 + z2 + z4) + (1 << ((13 - 4) - 1))) >> (13 - 4));
      dataptr[3] =
	(int16_t) (((tmp6 + z2 + z3) + (1 << ((13 - 4) - 1))) >> (13 - 4));
      dataptr[1] =
	(int16_t) (((tmp7 + z1 + z4) + (1 << ((13 - 4) - 1))) >> (13 - 4));
      dataptr += 8;
    }
}
